...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "blogs" ADD CONSTRAINT "blogs_blog_image_id_media_id_fk" FOREIGN KEY ("blog_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_blogs_v" ADD CONSTRAINT "_blogs_v_version_blog_image_id_media_id_fk" FOREIGN KEY ("version_blog_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "blogs_blog_image_idx" ON "blogs" USING btree ("blog_image_id");
  ...
  CREATE INDEX "_blogs_v_version_version_blog_image_idx" ON "_blogs_v" USING btree ("version_blog_image_id");
